...
# start_dates = pd.date_range('2011-01-01','2011-12-01', freq='1M')-pd.offsets.MonthBegin(1)
# stop_dates = pd.date_range('2011-02-01','2012-01-01', freq='1M')-pd.offsets.MonthBegin(1)
#yearly for all years
# start_dates = pd.date_range('2001-01-01','2020-01-01', freq='1Y')-pd.offsets.YearBegin(1)
# stop_dates = pd.date_range('2001-12-31','2020-12-31', freq='1Y')
start_dates = [pd.to_datetime('2010-01-01')]
stop_dates = [pd.to_datetime('2010-12-31')]
print(start_dates)
print(stop_dates)
